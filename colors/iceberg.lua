...
if vim.o.background == 'light' then
  ...
  hi(0, 'StatusLineNC', { reverse = true, bg = '#6b7089', fg = '#0f1117' })
  hi(0, 'StatusLineTermNC', { reverse = true, bg = '#6b7089', fg = '#0f1117' })
  ...
  hi(0, 'Visual', { bg = '#373944', fg = nil })
  hi(0, 'VisualNOS', { bg = '#373944', fg = nil })
